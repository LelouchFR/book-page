...
<template>
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" @click="openPopup = !openPopup">
    ...
    <div class="w-full h-full absolute top-0 left-0 flex items-center justify-center backdrop-blur-xs" v-if="openPopup">
        <section class="w-8/10 h-9/10 rounded-sm relative" :class="{ 'bg-yellow-300': settingsConfig.theme.type === 'light', 'bg-grey-700': settingsConfig.theme.type === 'custom' || settingsConfig.theme.type === 'dark' }">
            <div @click="openPopup = !openPopup" class="absolute top-4 right-4 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FF8000"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg>
            </div>
            ...
            <div class="px-3 py-3 flex flex-col gap-2">
                ...
                <div class="flex gap-2">
                    <div class="relative flex justify-center items-center bg-grey-700 h-20 w-40 rounded-sm border border-orange-500 cursor-pointer" @click="settingsConfig.theme.type = 'dark'">
                        <p>Dark</p>
                        <div class="absolute bottom-1 right-1">
                            <svg v-if="settingsConfig.theme.type !== 'dark'" xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#FF8000"><path d="M216-144q-29.7 0-50.85-21.15Q144-186.3 144-216v-528q0-29.7 21.15-50.85Q186.3-816 216-816h528q29.7 0 50.85 21.15Q816-773.7 816-744v528q0 29.7-21.15 50.85Q773.7-144 744-144H216Zm0-72h528v-528H216v528Z"/></svg>
                            <svg v-else xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#FF8000"><path d="m429-336 238-237-51-51-187 186-85-84-51 51 136 135ZM216-144q-29.7 0-50.85-21.15Q144-186.3 144-216v-528q0-29.7 21.15-50.85Q186.3-816 216-816h528q29.7 0 50.85 21.15Q816-773.7 816-744v528q0 29.7-21.15 50.85Q773.7-144 744-144H216Zm0-72h528v-528H216v528Zm0-528v528-528Z"/></svg>
                        </div>
                    </div>
                    <div class="relative flex justify-center items-center bg-yellow-300 h-20 w-40 rounded-sm border border-orange-500 cursor-pointer" @click="settingsConfig.theme.type = 'light'">
                        <p>Light</p>
                        <div class="absolute bottom-1 right-1">
                            <svg v-if="settingsConfig.theme.type !== 'light'" xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#FF8000"><path d="M216-144q-29.7 0-50.85-21.15Q144-186.3 144-216v-528q0-29.7 21.15-50.85Q186.3-816 216-816h528q29.7 0 50.85 21.15Q816-773.7 816-744v528q0 29.7-21.15 50.85Q773.7-144 744-144H216Zm0-72h528v-528H216v528Z"/></svg>
                            <svg v-else xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#FF8000"><path d="m429-336 238-237-51-51-187 186-85-84-51 51 136 135ZM216-144q-29.7 0-50.85-21.15Q144-186.3 144-216v-528q0-29.7 21.15-50.85Q186.3-816 216-816h528q29.7 0 50.85 21.15Q816-773.7 816-744v528q0 29.7-21.15 50.85Q773.7-144 744-144H216Zm0-72h528v-528H216v528Zm0-528v528-528Z"/></svg>
                        </div>
                    </div>
                    <div class="relative flex justify-center items-center bg-yellow-300 h-20 w-40 rounded-sm border border-orange-500 cursor-pointer" @click="settingsConfig.theme.type = 'custom'">
                        <p>Custom</p>
                        <div class="absolute bottom-1 right-1">
                            <svg v-if="settingsConfig.theme.type !== 'custom'" xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#FF8000"><path d="M216-144q-29.7 0-50.85-21.15Q144-186.3 144-216v-528q0-29.7 21.15-50.85Q186.3-816 216-816h528q29.7 0 50.85 21.15Q816-773.7 816-744v528q0 29.7-21.15 50.85Q773.7-144 744-144H216Zm0-72h528v-528H216v528Z"/></svg>
                            <svg v-else xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#FF8000"><path d="m429-336 238-237-51-51-187 186-85-84-51 51 136 135ZM216-144q-29.7 0-50.85-21.15Q144-186.3 144-216v-528q0-29.7 21.15-50.85Q186.3-816 216-816h528q29.7 0 50.85 21.15Q816-773.7 816-744v528q0 29.7-21.15 50.85Q773.7-144 744-144H216Zm0-72h528v-528H216v528Zm0-528v528-528Z"/></svg>
                        </div>
                    </div>
                </div>
